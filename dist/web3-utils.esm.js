...
// node_modules/.deno/isows@1.0.7/node_modules/isows/_esm/utils.js
...
// node_modules/.deno/isows@1.0.7/node_modules/isows/_esm/native.js
var native_exports = {};
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/constants/kzg.js
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/utils/authorization/serializeAuthorizationList.js
init_toHex();

// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/utils/transaction/serializeTransaction.js
init_transaction();
init_concat();
init_trim();
init_toHex();

// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/utils/transaction/assertTransaction.js
init_number();
init_address();
init_base();
init_chain();
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/utils/transaction/serializeAccessList.js
init_address();
init_transaction();
init_isAddress();
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/utils/rpc/http.js
init_request();

// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/utils/promise/withTimeout.js
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/utils/rpc/id.js
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/utils/rpc/webSocket.js
init_request();

// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/utils/rpc/socket.js
init_request();
init_createBatchScheduler();
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/utils/rpc/compat.js
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/clients/transports/http.js
init_request();

// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/errors/transport.js
init_base();
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/clients/transports/webSocket.js
init_request();
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/accounts/generatePrivateKey.js
init_secp256k1();
init_toHex();
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/accounts/privateKeyToAccount.js
init_secp256k1();
init_toHex();

// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/accounts/toAccount.js
init_address();
init_isAddress();
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/accounts/utils/sign.js
init_secp256k1();
init_isHex();
init_toBytes();
init_toHex();
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/accounts/utils/signAuthorization.js
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/accounts/utils/signMessage.js
async function signMessage2({ message, privateKey }) {
  return await sign({ hash: hashMessage(message), privateKey, to: "hex" });
}

// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/accounts/utils/signTransaction.js
init_keccak256();
...
// node_modules/.deno/viem@2.43.5/node_modules/viem/_esm/accounts/utils/signTypedData.js
...
var Web3Client = class {
  ...
  constructor(config = {}) {
    ...
    __publicField(this, "eventClient", null);
    // 专门用于事件监听的客户端（使用 WSS）
    __publicField(this, "walletClient", null);
    __publicField(this, "chain", null);
    // 事件监听器存储
    __publicField(this, "blockListeners", /* @__PURE__ */ new Set());
    __publicField(this, "transactionListeners", /* @__PURE__ */ new Set());
    __publicField(this, "contractEventListeners", /* @__PURE__ */ new Map());
    __publicField(this, "accountsChangedListeners", /* @__PURE__ */ new Set());
    __publicField(this, "chainChangedListeners", /* @__PURE__ */ new Set());
    // 事件监听器是否已启动
    __publicField(this, "blockListenerStarted", false);
    __publicField(this, "transactionListenerStarted", false);
    ...
    // viem watch 取消函数
    __publicField(this, "blockWatchUnsubscribe");
    __publicField(this, "transactionWatchUnsubscribe");
    __publicField(this, "contractWatchUnsubscribes", /* @__PURE__ */ new Map());
    // 自动重连相关
    __publicField(this, "blockReconnectTimer");
    __publicField(this, "transactionReconnectTimer");
    __publicField(this, "contractReconnectTimers", /* @__PURE__ */ new Map());
    __publicField(this, "reconnectDelay", 3e3);
    // 重连延迟（毫秒）
    __publicField(this, "maxReconnectAttempts", 10);
    // 最大重连次数
    __publicField(this, "blockReconnectAttempts", 0);
    __publicField(this, "transactionReconnectAttempts", 0);
    __publicField(this, "contractReconnectAttempts", /* @__PURE__ */ new Map());
    this.config = config;
  }
  /**
   * 获取配置
  ...
  getPublicClient() {
    ...
    try {
      ...
      throw new Error(
        `\u521B\u5EFA PublicClient \u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  /**
  ...
  getEventClient() {
    ...
    if (this.config.wssUrl) {
      try {
        ...
        console.warn(
          `[Web3Client] \u4F7F\u7528 WSS \u521B\u5EFA\u4E8B\u4EF6\u5BA2\u6237\u7AEF\u5931\u8D25\uFF0C\u56DE\u9000\u5230 HTTP: ${error instanceof Error ? error.message : String(error)}`
        );
  ...
  async sendTransaction(options) {
    ...
    try {
      ...
      if (options.maxFeePerGas) {
        ...
        txParams.maxPriorityFeePerGas = options.maxPriorityFeePerGas ? BigInt(options.maxPriorityFeePerGas.toString()) : void 0;
  ...
  async callContract(options, waitForConfirmation = true) {
    ...
    try {
      ...
      if (abiSource && Array.isArray(abiSource) && abiSource.length > 0) {
        ...
        parsedAbi = parseAbi(
          [`function ${options.functionSignature}`]
        );
      } else {
        const paramTypes = ((_a = options.args) == null ? void 0 : _a.map((arg) => this.inferArgType(arg))) || [];
        parsedAbi = parseAbi([
      ...
      try {
        ...
        if (receipt.status === "success") {
          ...
          receipt.error = "\u4EA4\u6613\u6267\u884C\u5931\u8D25\uFF0C\u5DF2\u88AB\u56DE\u6EDA";
          receipt.success = false;
          return receipt;
        } else {
          receipt.error = "\u672A\u77E5\u72B6\u6001";
          receipt.success = void 0;
          return receipt;
        }
      } catch (receiptError) {
        return {
  ...
  async readContract(options) {
    ...
    try {
      ...
      if (abiSource && Array.isArray(abiSource) && abiSource.length > 0 && typeof abiSource[0] === "object" && abiSource[0] !== null && !Array.isArray(abiSource[0])) {
        ...
        const paramTypes = ((_a = options.args) == null ? void 0 : _a.map((arg) => this.inferArgType(arg))) || [];
        const functionSignature = options.functionSignature || `${options.functionName}(${paramTypes.join(",")})`;
        ...
        if (options.functionSignature) {
          ...
          const paramTypes = ((_b = options.args) == null ? void 0 : _b.map(
            (arg) => this.inferArgType(arg)
          )) || [];
          const returnType = options.returnType || "uint256";
          parsedAbi = parseAbi(
            [
              `function ${options.functionName}(${paramTypes.join(",")}) view returns (${returnType})`
            ]
          );
        }
      }
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      if (errorMessage.includes("revert") || errorMessage.includes("execution reverted") || errorMessage.includes('value="0x"') || errorMessage.includes("BAD_DATA")) {
        throw new Error(
          `\u5408\u7EA6\u8C03\u7528\u8FD4\u56DE\u7A7A\u6570\u636E\u6216\u6267\u884C revert\u3002\u5408\u7EA6\u5730\u5740: ${contractAddress}\uFF0C\u51FD\u6570: ${options.functionName}\uFF0C\u53C2\u6570: ${JSON.stringify(options.args)}\uFF0C\u9519\u8BEF: ${errorMessage}`
        );
      }
      throw new Error(
        `\u8BFB\u53D6\u5408\u7EA6\u5931\u8D25: ${errorMessage}`
  ...
  stopBlockListener() {
    ...
    if (this.blockReconnectTimer) {
      ...
      this.blockReconnectTimer = void 0;
    }
    try {
      if (this.blockWatchUnsubscribe) {
        this.blockWatchUnsubscribe();
        this.blockWatchUnsubscribe = void 0;
      }
      this.blockListenerStarted = false;
      this.blockReconnectAttempts = 0;
    } catch (error) {
  ...
  scheduleBlockReconnect() {
    ...
    const delay = this.reconnectDelay * this.blockReconnectAttempts;
   ...
   * 处理交易监听错误并安排重连
   */
  handleTransactionListenerError() {
  ...
  scheduleTransactionReconnect() {
    ...
    const delay = this.reconnectDelay * this.transactionReconnectAttempts;
  ...
  stopTransactionListener() {
    ...
    if (this.transactionReconnectTimer) {
      clearTimeout(this.transactionReconnectTimer);
      this.transactionReconnectTimer = void 0;
    }
    try {
      if (this.transactionWatchUnsubscribe) {
        this.transactionWatchUnsubscribe();
        this.transactionWatchUnsubscribe = void 0;
      }
      this.transactionListenerStarted = false;
      this.transactionReconnectAttempts = 0;
    } catch (error) {
  ...
  onContractEvent(contractAddress, eventName, callback, options) {
    ...
    if (!this.contractEventListeners.has(key)) {
      this.contractEventListeners.set(key, /* @__PURE__ */ new Set());
    }
    const listeners = this.contractEventListeners.get(key);
    listeners.add(callback);
    if ((options == null ? void 0 : options.fromBlock) !== void 0) {
    ...
    this.startContractEventListener(contractAddress, eventName, options == null ? void 0 : options.abi);
    return () => {
   ...
   * @private
   */
  async scanHistoricalContractEvents(contractAddress, eventName, callback, fromBlock, toBlock, abi2) {
    try {
      const client = this.getPublicClient();
      const currentBlock = toBlock ?? await this.getBlockNumber();
      const startBlock = Math.max(fromBlock, 0);
      let logs;
      if (abi2 && abi2.length > 0) {
        const parsedAbi = typeof abi2[0] === "string" ? parseAbi(abi2) : abi2;
      ...
      throw new Error(
        `\u626B\u63CF\u5386\u53F2\u5408\u7EA6\u4E8B\u4EF6\u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  /**
   * 启动合约事件监听
   */
  startContractEventListener(contractAddress, eventName, abi2) {
    const key = `${contractAddress}:${eventName}`;
    ...
    try {
      const client = this.getEventClient();
      const eventAbi = abi2 ? typeof abi2[0] === "string" ? parseAbi(abi2) : abi2 : parseAbi([`event ${eventName}()`]);
      ...
      this.scheduleContractReconnect(contractAddress, eventName, abi2);
    }
  }
  /**
   * 处理合约事件监听错误并安排重连
   */
  handleContractEventListenerError(contractAddress, eventName) {
    const key = `${contractAddress}:${eventName}`;
   ...
   * 安排合约事件监听重连
   */
  scheduleContractReconnect(contractAddress, eventName, abi2) {
    const key = `${contractAddress}:${eventName}`;
    ...
    const timer = setTimeout(() => {
      try {
        this.publicClient = null;
        this.startContractEventListener(contractAddress, eventName, abi2);
      } catch (error) {
   ...
   * 停止合约事件监听
   */
  stopContractEventListener(contractAddress, eventName) {
    const key = `${contractAddress}:${eventName}`;
   ...
   */
  offContractEvent(contractAddress, eventName) {
    if (eventName) {
      const key = `${contractAddress}:${eventName}`;
      this.contractEventListeners.delete(key);
      this.stopContractEventListener(contractAddress, eventName);
      ...
      for (const [key, listeners] of this.contractEventListeners.entries()) {
        if (key.startsWith(`${contractAddress}:`)) {
          const eventName2 = key.split(":")[1];
          this.stopContractEventListener(contractAddress, eventName2);
          listeners.clear();
          this.contractEventListeners.delete(key);
        }
      }
  ...
  async getBlockNumber() {
    ...
    try {
      ...
      throw new Error(
        `\u83B7\u53D6\u533A\u5757\u53F7\u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  /**
  ...
  async getGasLimit(blockNumber) {
    ...
    try {
      ...
      throw new Error(
        `\u83B7\u53D6 Gas \u9650\u5236\u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  /**
  ...
  async getFeeData() {
    ...
    try {
      ...
      return {
        ...
        maxPriorityFeePerGas: fees.maxPriorityFeePerGas ? String(fees.maxPriorityFeePerGas) : null
      };
    } catch (error) {
      throw new Error(
        `\u83B7\u53D6\u8D39\u7528\u6570\u636E\u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  /**
  ...
  async getBalances(addresses) {
    ...
    try {
      ...
      throw new Error(
        `\u6279\u91CF\u83B7\u53D6\u4F59\u989D\u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  /**
   ...
   * @returns 交易数组
   */
  async getBlockTransactions(blockNumber, includeTransactions = false) {
    const client = this.getPublicClient();
    try {
      const block = await client.getBlock({
      ...
      throw new Error(
        `\u83B7\u53D6\u533A\u5757\u4EA4\u6613\u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  /**
   ...
   * @returns 交易数组
   */
  async getAddressTransactions(address, fromBlock, toBlock) {
    var _a, _b;
    const client = this.getPublicClient();
    try {
      const currentBlock = toBlock ?? await this.getBlockNumber();
      const startBlock = fromBlock ?? Math.max(0, currentBlock - 1e3);
      ...
      for (const log of logs) {
        ...
        if (txHash && !txHashes.has(txHash)) {
          ...
          try {
            ...
            if (((_a = tx.from) == null ? void 0 : _a.toLowerCase()) === address.toLowerCase() || ((_b = tx.to) == null ? void 0 : _b.toLowerCase()) === address.toLowerCase()) {
      ...
      throw new Error(
        `\u83B7\u53D6\u5730\u5740\u4EA4\u6613\u5386\u53F2\u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  /**
   ...
   */
  async scanContractMethodTransactions(contractAddress, functionSignature, options = {}) {
    const client = this.getPublicClient();
    try {
      const hash3 = keccak256(functionSignature);
      const functionSelector = hash3.slice(0, 10);
      const selectorLower = functionSelector.toLowerCase();
      const currentBlock = options.toBlock ?? await this.getBlockNumber();
      const startBlock = options.fromBlock ?? Math.max(0, currentBlock - 1e4);
              ...
              try {
                ...
                if (block.transactions && Array.isArray(block.transactions)) {
                  for (const tx of block.transactions) {
                    const txObj = tx;
                    if (txObj.to && txObj.to.toLowerCase() === contractAddress.toLowerCase() && txObj.data && txObj.data.toLowerCase().startsWith(selectorLower)) {
                      let args;
                      if (options.abi) {
                        try {
                          const abi2 = typeof options.abi[0] === "string" ? parseAbi(options.abi) : options.abi;
                          const functionName = functionSignature.split("(")[0];
                          const func = abi2.find(
                      ...
                      try {
                        ...
                        gasUsed = (_a = receipt.gasUsed) == null ? void 0 : _a.toString();
                      } catch {
                      }
                      allTransactions.push({
                        ...
                        gasUsed,
                        gasPrice: (_b = txObj.gasPrice) == null ? void 0 : _b.toString(),
                        value: ((_c = txObj.value) == null ? void 0 : _c.toString()) || "0",
                        data: txObj.data,
                        args,
                        receipt
                      });
      ...
      throw new Error(
        `\u626B\u63CF\u5408\u7EA6\u65B9\u6CD5\u4EA4\u6613\u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  /**
  ...
  async getCode(address) {
    ...
    try {
      ...
      throw new Error(
        `\u83B7\u53D6\u5408\u7EA6\u4EE3\u7801\u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  async isContract(address) {
    ...
    try {
      ...
      return code !== void 0 && code !== "0x" && code.length > 2;
    } catch (error) {
      throw new Error(
        `\u68C0\u67E5\u5408\u7EA6\u5730\u5740\u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
};
...
async function keccak2563(data) {
  try {
    const dataHex = typeof data === "string" ? data.startsWith("0x") ? data : "0x" + data : data;
    return keccak256(dataHex);
  } catch {
    const encoder5 = new TextEncoder();
    const dataBytes = typeof data === "string" ? encoder5.encode(data) : new Uint8Array(data);
    const hashBuffer = await crypto.subtle.digest("SHA-256", dataBytes.buffer);
    const hashArray = Array.from(new Uint8Array(hashBuffer));
    return "0x" + hashArray.map((b) => b.toString(16).padStart(2, "0")).join("");
  }
}
async function solidityKeccak256(types, values) {
  try {
    ...
    return await keccak2563(encoded);
  }
}
...
function padLeft2(value, length, padChar = "0") {
  return value.padStart(length, padChar);
}
function padRight3(value, length, padChar = "0") {
...
function isTxHash(txHash) {
  ...
  const hash3 = txHash.startsWith("0x") ? txHash.slice(2) : txHash;
  return /^[0-9a-fA-F]{64}$/.test(hash3);
}
...
async function computeContractAddress(deployerAddress, nonce) {
  const data = formatAddress(deployerAddress) + numberToHex2(nonce).slice(2);
  const hash3 = await keccak2563(data);
  return "0x" + hash3.slice(-40);
}
async function getCode2(address, rpcUrl) {
  if (!isAddress(address)) {
    throw new Error(`\u65E0\u6548\u7684\u5730\u5740: ${address}`);
  }
...
function getFunctionSelector(functionSignature) {
  ...
  const hash3 = keccak256(functionSignature);
  return hash3.slice(0, 10);
}
function encodeFunctionCall(functionSignature, args = []) {
  if (!functionSignature || typeof functionSignature !== "string") {
    throw new Error("\u51FD\u6570\u7B7E\u540D\u4E0D\u80FD\u4E3A\u7A7A");
  }
  try {
    ...
    throw new Error(
      `\u7F16\u7801\u51FD\u6570\u8C03\u7528\u5931\u8D25: ${error instanceof Error ? error.message : String(error)}`
    );
  }
}
export {
  ...
  isPrivateKey,
  isTxHash,
  keccak2563 as keccak256,
  numberToHex2 as numberToHex,
  padLeft2 as padLeft,
  padRight3 as padRight,
  shortenAddress,
  solidityKeccak256,
  stripHexPrefix,
  toChecksumAddress,
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=web3-utils.esm.js.map
