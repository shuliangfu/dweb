 ...
 * 首页组件
 * 路由: /
 * SSG 示例：含客户端激活计数器（hydrate 后点击可更新）
 */
    ...
    <div class="py-5">
      ...
      <section class="mb-10">
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="rounded-lg bg-white p-6 shadow-md">
            <h3 class="mb-2.5 text-[#667eea]">View</h3>
            <p>轻量级响应式视图引擎</p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        {
          /*
           * 整块用无参箭头包一层，与 view-ssr basic / view-csr 一致，保证 SSG + hydrate 下交互正常。
           * data-counter-value 绑定供 e2e 读取。
           */
        }
        {() => (
