    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">角色列表</h2>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">权限列表</h2>
          <div className="space-y-2">
            {permissions.map((perm) => (
              ...
              >
                ...
                <span className="text-xs text-gray-400">{perm.module}</span>
              </div>
            ))}
          </div>
        </div>
