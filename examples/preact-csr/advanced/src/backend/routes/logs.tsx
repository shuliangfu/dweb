    ...
    <div class="space-y-6">
      ...
      <div class="flex gap-4">
        ...
        <input
          type="text"
          placeholder="搜索日志..."
          class="flex-1 max-w-md px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
        />
      </div>
        ...
        <table class="w-full">
          <thead class="bg-gray-50">
            <tr class="text-left text-sm text-gray-500">
              ...
              <th class="px-6 py-4 font-medium">消息</th>
          ...
          <tbody class="divide-y divide-gray-100">
            {mockLogs.map((log) => (
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 text-gray-900">{log.message}</td>
                <td class="px-6 py-4 text-gray-500">{log.source}</td>
                <td class="px-6 py-4 text-gray-500 text-sm">{log.time}</td>
              </tr>
            ))}
          </tbody>
        </table>
