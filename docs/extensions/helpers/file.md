...
```typescript
import { readFile } from "@dreamer/dweb/extensions";
...
```typescript
import { readFileAsDataUrl } from "@dreamer/dweb/extensions";
...
```typescript
import { readFileAsArrayBuffer } from "@dreamer/dweb/extensions";
...
```typescript
import { getFileExtension } from "@dreamer/dweb/extensions";
...
```typescript
import { getFileName } from "@dreamer/dweb/extensions";
...
```typescript
import { getFileSize } from "@dreamer/dweb/extensions";
...
```typescript
import { isImageFile, isVideoFile, isAudioFile } from "@dreamer/dweb/extensions";
...
```typescript
import { compressImage } from "@dreamer/dweb/extensions";
...
```typescript
import { createFile } from "@dreamer/dweb/extensions";
...
```typescript
import { getMimeType } from "@dreamer/dweb/extensions";
