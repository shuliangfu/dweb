...
```typescript
import { clamp, round, random, sum, percent } from "@dreamer/dweb/extensions";
...
```typescript
import { clamp } from "@dreamer/dweb/extensions";
...
```typescript
import { round, floor, ceil } from "@dreamer/dweb/extensions";
...
```typescript
import { random, randomInt } from "@dreamer/dweb/extensions";
...
```typescript
import { percent } from "@dreamer/dweb/extensions";
...
```typescript
import { lerp } from "@dreamer/dweb/extensions";
...
```typescript
import { distance } from "@dreamer/dweb/extensions";
...
```typescript
import { inRange } from "@dreamer/dweb/extensions";
