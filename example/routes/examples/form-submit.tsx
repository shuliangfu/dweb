 ...
 * @returns JSX 元素
 */
export default function FormSubmitPage({ params: _params, query: _query, data: _data }: PageProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 p-10 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700">
        <form className="max-w-xl mx-auto space-y-6" onSubmit={handleCreateExample}>
          <div>
