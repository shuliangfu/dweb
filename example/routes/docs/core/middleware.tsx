...
export default function CoreMiddlewarePage({ params: _params, query: _query, data: _data }: PageProps) {
...
await server.start(3000);`;
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* 侧边栏导航 */}
      <Sidebar currentPath="/docs/core/middleware" />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="prose prose-lg max-w-none">
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6 border-b border-gray-200 pb-2">什么是中间件</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  中间件是一个函数，接收请求、响应和下一个中间件函数作为参数。中间件可以：
                </p>
                <ul className="list-disc list-inside space-y-2 my-4">
                  <li className="text-gray-700">在请求处理前执行逻辑（如身份验证、日志记录）</li>
                  <li className="text-gray-700">在请求处理后执行逻辑（如响应压缩、错误处理）</li>
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6 border-b border-gray-200 pb-2">使用中间件</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  在服务器上使用中间件：
                </p>
              ...
              <section className="mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6 border-b border-gray-200 pb-2">中间件执行顺序</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  中间件按照添加的顺序执行。在调用 <code className="bg-gray-100 px-2 py-1 rounded">next()</code> 之前执行的代码会在请求处理前运行，在调用 <code className="bg-gray-100 px-2 py-1 rounded">next()</code> 之后执行的代码会在请求处理后运行。
                </p>
              </section>
              ...
              <section className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  框架提供了多个内置中间件，详见 <a href="/docs/middleware" className="text-indigo-600 hover:text-indigo-700 hover:underline">中间件文档</a>。
                </p>
              </section>
            </article>
          </div>
