  ...
  return (
    <article className="prose prose-lg max-w-none">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">在应用中使用插件：</p>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc list-inside space-y-2 my-4">
          <li className="text-gray-700">
            <code className="bg-gray-100 px-2 py-1 rounded">onInit</code>{" "}
            - 应用初始化时执行
          </li>
          <li className="text-gray-700">
            <code className="bg-gray-100 px-2 py-1 rounded">onRequest</code>
            {" "}
            - 每个请求前执行
          </li>
          <li className="text-gray-700">
            <code className="bg-gray-100 px-2 py-1 rounded">onResponse</code>
            {" "}
            - 每个响应后执行
          </li>
          <li className="text-gray-700">
            <code className="bg-gray-100 px-2 py-1 rounded">onError</code>{" "}
            - 发生错误时执行
          </li>
          <li className="text-gray-700">
            <code className="bg-gray-100 px-2 py-1 rounded">onBuild</code>{" "}
            - 构建时执行
          </li>
          <li className="text-gray-700">
            <code className="bg-gray-100 px-2 py-1 rounded">onStart</code>{" "}
            - 服务器启动时执行
          </li>
        </ul>
      </section>
