...
export default function PwaPluginPage({ params: _params, query: _query, data: _data }: PageProps) {
...
plugins: [
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* 侧边栏导航 */}
      <Sidebar currentPath="/docs/plugins/pwa" />
        ...
        <div className="py-8">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="prose prose-lg max-w-none">
              <h1 className="text-4xl font-bold text-gray-900 mb-8">pwa - 渐进式 Web 应用</h1>
              ...
              <section className="mb-12">
                ...
                <ul className="list-disc list-inside space-y-2 my-4">
                  <li className="text-gray-700"><code className="bg-gray-100 px-2 py-1 rounded">manifest</code> - Web App Manifest 配置</li>
                </ul>
              </section>
            </article>
          </div>
