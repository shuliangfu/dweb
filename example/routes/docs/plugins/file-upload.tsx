...
export default function FileUploadPluginPage({ params: _params, query: _query, data: _data }: PageProps) {
...
plugins: [
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* 侧边栏导航 */}
      <Sidebar currentPath="/docs/plugins/file-upload" />
        ...
        <div className="py-8">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="prose prose-lg max-w-none">
              <h1 className="text-4xl font-bold text-gray-900 mb-8">fileUpload - 文件上传</h1>
              ...
              <section className="mb-12">
                ...
                <ul className="list-disc list-inside space-y-2 my-4">
                  <li className="text-gray-700"><code className="bg-gray-100 px-2 py-1 rounded">dest</code> - 文件保存目录</li>
                  <li className="text-gray-700"><code className="bg-gray-100 px-2 py-1 rounded">limits</code> - 文件大小限制</li>
                </ul>
              </section>
            </article>
          </div>
