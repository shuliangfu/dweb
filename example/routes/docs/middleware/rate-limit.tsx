...
export default function RateLimitMiddlewarePage({ params: _params, query: _query, data: _data }: PageProps) {
...
server.use(rateLimit({
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* 侧边栏导航 */}
      <Sidebar currentPath="/docs/middleware/rate-limit" />
        ...
        <div className="py-8">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <article className="prose prose-lg max-w-none">
              <h1 className="text-4xl font-bold text-gray-900 mb-8">rateLimit - 速率限制</h1>
              ...
              <section className="mb-12">
                ...
                <ul className="list-disc list-inside space-y-2 my-4">
                  <li className="text-gray-700"><code className="bg-gray-100 px-2 py-1 rounded">windowMs</code> - 时间窗口（毫秒）</li>
                  <li className="text-gray-700"><code className="bg-gray-100 px-2 py-1 rounded">max</code> - 在时间窗口内的最大请求数</li>
                </ul>
              </section>
            </article>
          </div>
