      ...
      <section className="mb-12">
        ...
        <ul className="list-disc list-inside space-y-2 my-4">
          <li className="text-gray-700">
            <code className="bg-gray-100 px-2 py-1 rounded">json</code>{" "}
            - JSON 解析配置
          </li>
          <li className="text-gray-700">
            <code className="bg-gray-100 px-2 py-1 rounded">urlencoded</code>
            {" "}
            - URL-encoded 解析配置
          </li>
          <li className="text-gray-700">
          ...
          <li className="text-gray-700">
            <code className="bg-gray-100 px-2 py-1 rounded">raw</code>{" "}
            - 原始数据解析配置
          </li>
        </ul>
      </section>
