...
export default function AuthMiddlewarePage({ params: _params, query: _query, data: _data }: PageProps) {
...
server.use(auth({
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* 侧边栏导航 */}
      <Sidebar currentPath="/docs/middleware/auth" />
            ...
            <article className="prose prose-lg max-w-none">
              ...
              <section className="mb-12">
                ...
                <ul className="list-disc list-inside space-y-2 my-4">
                  <li className="text-gray-700"><code className="bg-gray-100 px-2 py-1 rounded">secret</code> - JWT 密钥</li>
                  <li className="text-gray-700"><code className="bg-gray-100 px-2 py-1 rounded">algorithms</code> - 支持的算法列表</li>
                </ul>
              </section>
            </article>
          </div>
