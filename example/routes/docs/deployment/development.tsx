  ...
  return (
    <article className="prose prose-lg max-w-none">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          <strong>注意：</strong>
          <code className="bg-gray-100 px-2 py-1 rounded">main.ts</code>{" "}
          文件是可选的，不是必须的。框架可以通过 CLI 命令自动启动服务器。
        </p>
        <p className="text-gray-700 leading-relaxed mb-4">
          如果你需要自定义应用配置（如添加中间件、插件等），可以创建{" "}
          <code className="bg-gray-100 px-2 py-1 rounded">main.ts</code> 文件：
        </p>
