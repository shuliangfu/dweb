...
export default function Navbar({ currentPath: initialPath }: NavbarProps) {
  ...
  return (
    <nav className="bg-gray-50/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-sm border-b border-gray-300 dark:border-gray-700 sticky top-0 z-50">
        ...
        <div className="flex justify-between items-center h-16">
                ...
                <a
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                    isActive
                      ...
                      : 'text-gray-800 dark:text-gray-300 hover:text-blue-700 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-800'
                  }`}
                >
                  {item.label}
                </a>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="p-2 rounded-md text-gray-700 hover:text-gray-900 hover:bg-gray-200 dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-800 transition-colors"
              title="切换主题"
              aria-label="切换主题"
            >
              {theme === 'dark' ? (
            ...
            <a
              ...
              className="hidden md:inline-flex items-center px-4 py-2 text-sm font-medium text-gray-800 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors"
            >
