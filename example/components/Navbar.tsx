        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              onClick={() => {
                if (typeof globalThis !== 'undefined' && globalThis.window) {
                  const toggleTheme = (globalThis.window as any).toggleTheme;
            ...
            <a
              ...
              className="hidden md:inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors"
            >
