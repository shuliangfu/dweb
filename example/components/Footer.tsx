    ...
    <footer className="bg-gray-900 dark:bg-gray-950 text-gray-300 dark:text-gray-400 border-t border-gray-800 dark:border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          {/* 关于 */}
          <div>
            <h3 className="text-white dark:text-gray-100 text-lg font-bold mb-4">DWeb</h3>
          ...
          {/* 快速链接 */}
          <div>
            <h4 className="text-white dark:text-gray-100 text-sm font-semibold mb-4">快速链接</h4>
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/features" className="text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-200 transition-colors">
                  特性
                </a>
              </li>
              <li>
                <a href="/docs" className="text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-200 transition-colors">
                  文档
                </a>
              </li>
              <li>
                <a href="/about" className="text-gray-400 dark:text-gray-500 hover:text-white dark:hover:text-gray-200 transition-colors">
                  关于
                </a>
              </li>
            </ul>
          ...
          {/* 资源 */}
          <div>
            <h4 className="text-white dark:text-gray-100 text-sm font-semibold mb-4">资源</h4>
            <ul className="space-y-2 text-sm">
              <li>
                <a
          ...
          {/* 联系 */}
          <div>
            <h4 className="text-white dark:text-gray-100 text-sm font-semibold mb-4">社区</h4>
